...
class RoundService {
    ...
    async roundSync(socket, chosenWord) {
        ...
        if (chosenWord && chosenWord.trim() != "") {
            ...
            if (room.isFinalOver()) {
                ...
                const nextPlayer = nextPlayerId ? mapService.getEntity(nextPlayerId) : undefined;
                if (!nextPlayer) {
